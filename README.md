...
Would you like me to help you refine the README further or perhaps assist in drafting the technical documentation for the NMS post-processing logic?

---

Below is the original Chinese documentation (kept for convenience):
